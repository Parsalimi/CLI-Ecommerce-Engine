...
Planned improvements (from early design notes) include a graphical UI, wallet/balance system, discounts, ratings, refunds, and richer admin roles. See `archive/README.md` for the full idea list.
